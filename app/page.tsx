...
export default function Home() {
  return (
    ...
    //   <header className="absolute inset-x-0 top-0 z-10 w-full h-full">
    ...
    // </div>
    <div>
      <h1 className="text-lg justify-center items-center font-bold pt-16 ">
        We can Build Next JS 13 Apps with Tailwind CSS and Prisma
      </h1>
    </div>
  );
}
